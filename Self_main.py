...
class MainApplication(tk.Frame):
    ...
    def new_project(self):
        ...
        # ok button command
        ok_button = Button(self.master, text="OK",
                           command=show_button, bg="brown")
        ok_button.place(x=320, y=23)

        # start button
        btn_strat = Button(self.master, text="Strat",
                           command=start, bg="green")
    ...
    def open_project(self):
        ...
        if folder_path:
            ...
            # #create a lable if the item is found
            #     Label(self.master , text ="object1 :").place(x= 10,y= 210)
            def show_button():
                selection = dropdown.get()
                if selection == "             1              " :
                    button1.place(x=150, y=60)
